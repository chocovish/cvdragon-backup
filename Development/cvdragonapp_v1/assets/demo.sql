...
--
-- Host: 127.0.0.1
-- Generation Time: Jun 14, 2019 at 07:13 AM
...
CREATE TABLE `cv-add-section` (  `addid` int(11) NOT NULL,  `id` bigint(20) NOT NULL,  `heading` varchar(200) NOT NULL,
  `subHeading` text NOT NULL,  `description` text NOT NULL,  `showAfter` int(11) NOT NULL,  `created` timestamp NOT NULL DEFAULT CURRENT_TIMESTAMP    ,  `proofRead` tinyint(4) NOT NULL,  `proofReadDate` date NOT NULL,  `status` tinyint(4) NOT NULL)  ;
...
CREATE TABLE `cv-association` (  `associationid` int(11) NOT NULL,  `id` bigint(20) NOT NULL,  `organization` varchar(100)  NOT NULL,  `position` varchar(50)  NOT NULL,  `location` varchar(50)  NOT NULL,  `description` mediumtext  NOT NULL,  `dateJoining` date NOT NULL,  `dateLeaving` date DEFAULT NULL,  `present` tinyint(4) NOT NULL,  `created` timestamp NOT NULL DEFAULT CURRENT_TIMESTAMP    ,  `proofRead` tinyint(4) NOT NULL,  `proofReadDate` date NOT NULL,  `status` tinyint(1) NOT NULL)    ;
