...
class MyPdfScaffold extends StatefulWidget {
...
class _PDFViewScaffoldState extends State<MyPdfScaffold> {
  ...
  Rect _buildRect(BuildContext context) {
    ...
    return new Rect.fromLTWH(0.0, top, mediaQuery.size.width, height-90);
  }
}
