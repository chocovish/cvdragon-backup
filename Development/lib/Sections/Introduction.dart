...
var data = [];
var introduction = data[index]['introduction'];
var title = data[index]['title'];

class Introduction extends StatelessWidget {
  Introduction(String d2, String i2, int i1, List d, List k2, List d1, List d3) {
    section = d2;
    secName = i2;
    index = i1;
    data = d;
  ...
  update(BuildContext context,String t, String i, Map<String, dynamic> initial) {
...
//                                  },
                            ...
                            Container(
                              ...
                              child: TextField(
                                controller: new TextEditingController.fromValue(
                                    new TextEditingValue(
                                        text: data[index]['introduction'],
                                        selection: new TextSelection.collapsed(
                                            offset: introduction.length))),
                                onChanged: (val) => introduction = val,
                                //autofocus: true,
                                ...
                                children: <Widget>[
                                  InkWell(
                                    ...
                                    child: Container(
                                      ...
                                      child: InkWell(
                                        onTap: () {
                                          update(context, title, introduction, data[index]);
                                        },
