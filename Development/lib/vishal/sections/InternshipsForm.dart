...
class InternshipsForm extends StatefulWidget {
  Map instance;

  InternshipsForm({Map i}) : instance = i ?? {};

  @override
  _InternshipsFormState createState() => _InternshipsFormState();
}

class _InternshipsFormState extends State<InternshipsForm> {
  final section = "51106";
      ...
      child: FormBuilder(
        ...
        child: Column(
          children: <Widget>[
            ...
            myTextField("designation",initialValue: widget.instance["designation"]),
