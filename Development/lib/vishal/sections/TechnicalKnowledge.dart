  ...
  Widget build(BuildContext context) {
    ...
    return Container(
      ...
      child: FormBuilder(
        ...
        child: Column(
          children: <Widget>[
            myTextField("technical",initialValue: widget.instance["technical"]),
            myTextField("type",initialValue: widget.instance["type"]),
            mySegmentField("level",initialValue: widget.instance["level"],options: ["Beginner","Intermideate",'Advanced']),
